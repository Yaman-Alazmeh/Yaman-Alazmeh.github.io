...
An endless runner game developed in Unreal Engine, focused on fast-paced gameplay, procedural level generation, and increasing difficulty over time.
<br>
**Key Features:**
<br>
...
This project implements a classic endless runner experience where the player continuously moves forward through a dynamically generated 3D environment. The game tracks the distance traveled (in meters) as the player’s score.

The environment is built using a tile-based system that spawns new segments seamlessly, creating the illusion of an infinite world. Obstacles are generated randomly along the path, requiring the player to react quickly and navigate effectively. And managing Memory Utilization while the game is being played.
